...
public class JwtSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.csrf().disable().authorizeRequests()
                ...
                .antMatchers("/folder/create").permitAll()
                .antMatchers("/folder/getByParent").permitAll()
                .antMatchers("/folder/getByOwner").permitAll()
                .antMatchers("/folder/getRootAndPublic\"").permitAll()
                .antMatchers("/folder/getOwnerAndRoot").permitAll()
                .antMatchers("/document/create").permitAll()
                .antMatchers("/document/getByRootAndOwner").permitAll()
                .antMatchers("/document/getByOwnerAndFolder").permitAll()
                .antMatchers("/document/getByRootAndPublic").permitAll()
